...
/obj/item/clothing/suit/armor/odst
	name = "ODST Armored Suit"
	desc = "High endurace armor for ODST"
	icon_state = "odst"
	item_state = "odst"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|FEET|ARMS|HANDS
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT
	...
	min_cold_protection_temperature = SPACE_SUIT_MIN_COLD_PROTECTION_TEMPERATURE
	slowdown = 0
	armor = list(melee = 60, bullet = 60, laser = 5, energy = 5, bomb = 60, bio = 60, rad = 60)

/obj/item/clothing/suit/armor/spartan
	name = "Spartan Armor"
	desc = "Ultra High Endurance armor for Spartan Soldiers."
	icon_state = "spartan"
	item_state = "spartan"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|FEET|ARMS|HANDS
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT
