...
/datum/game_mode/insurgency
	name = "insurgency"
	config_tag = "insurgency"
	required_players = 6
...
/datum/game_mode/nuclear/announce()
	world << "<B>The current game mode is - Insurgency!</B>"
...
/datum/game_mode/nuclear/can_start()//This could be better, will likely have to recode it later
	...
	var/list/possible_syndicates = get_players_for_role(ROLE_INSURGENCY)
	var/agent_number = 0
...
/datum/game_mode/insurgency/pre_setup()
	return 1
...
/datum/game_mode/insurgency/post_setup()
...
/datum/game_mode/insurgency/check_win()
	if (nukes_left == 0)
		return 1
	return ..()
...
/datum/game_mode/insurgency/declare_completion()
	var/disk_rescued = 1
