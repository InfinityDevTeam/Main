...
/datum/computer/file/computer_program/RDid
	name = "CardIdentity"
	size = 23.7
	program_screen_icon = "idRD"
	var/mode = 0.0
	var/printing = null
...
/datum/computer/file/computer_program/MEDid
	name = "CardIdentity"
	size = 23.7
	program_screen_icon = "idMedBay"
	var/mode = 0.0
	var/printing = null
...
/datum/computer/file/computer_program/SECid
	name = "CardIdentity"
	size = 23.7
	program_screen_icon = "idSec"
	var/mode = 0.0
	var/printing = null
...
/datum/computer/file/computer_program/ENGid
	name = "CardIdentity"
	size = 23.7
	program_screen_icon = "idEng"
	var/mode = 0.0
	var/printing = null
